          ...
          >
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className='text-lg'>{isDark ? <FaSun /> : <FaMoon />}</button>
            </div>
            {/* top bar */}
            <div className="flex justify-between items-center mb-5">
              <span className="bg-indigo-500 text-white px-4 py-1.5 rounded-md text-sm">
                TODO
              </span>

              <span className="text-sm bg-gray-700 px-3 py-1 rounded-md text-gray-300">
                All
              </span>
            </div>
            {/* input data */}
            <div className="flex gap-2 mb-6">
              <input
                ...
                className={`flex-1 px-4 py-2 rounded-md bg-gray-700 border border-gray-600 text-sm text-white ${isDark ? "bg-gray-700 border-gray-600 text-white" : "border-gray-300"}`}
              />
          ...
          {showModal && (
            <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center">
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className={`w-80 rounded-lg p-6 ${isDark
